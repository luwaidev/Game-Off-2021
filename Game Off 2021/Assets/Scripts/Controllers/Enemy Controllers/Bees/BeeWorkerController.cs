...
public class BeeWorkerController : MonoBehaviour, EnemyInterface
{
    ...
    public void SetRandomPosition()
    {
        ...
        } while ((bool)Physics2D.Raycast(transform.position, (targetPosition - (Vector2)transform.position).normalized, Vector2.Distance(targetPosition, transform.position), wallLayer));
    }
